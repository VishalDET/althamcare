...
const Footer = () => {
  return (
    <footer className="relative bg-[#2D1B20] text-white pt-32 pb-12 overflow-hidden">
      {/* Wavy Divider */}
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 relative z-10">
        <div className="space-y-8">
          <Link to="/" className="flex items-center gap-3">
            <div className="bg-white p-2.5 rounded-2xl shadow-premium">
              <Heart className="text-primary" size={24} fill="currentColor" />
            </div>
            <div className="flex flex-col -space-y-1">
              <span className="text-2xl font-black text-white tracking-tighter uppercase italic">Altham</span>
              <span className="text-xs font-bold text-accent-pale tracking-[0.3em] uppercase ml-0.5">Care Home</span>
            </div>
          </Link>
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20 pt-8 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6 text-sm font-bold text-white/40">
